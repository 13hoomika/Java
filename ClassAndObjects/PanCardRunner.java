class PanCardRunner{
	public static void main(String card[]){
		...
		pan1.panNumber="ABCDE1234F";
		pan1.name="Rohan Verma";
		pan1.fatherName=" Rajesh Verma";
		pan1.dob="12-05-1990";
		pan1.PanCardDetails();	

		PanCard pan2= new PanCard();
		pan2.panNumber="FGHIJ5678K";
		pan2.name="Neha Sharm";
		pan2.fatherName="Suresh Sharma";
		pan2.dob=" 23-08-1993";
		pan2.PanCardDetails();

		PanCard pan3= new PanCard();
		pan3.panNumber="KLMNO9101P";
		pan3.name=" Sandeep Kumar";
		pan3.fatherName=" Prakash Kumar";
		pan3.dob="15-11-1985";
		pan3.PanCardDetails();

		PanCard pan4= new PanCard();
		pan4.panNumber="PQRST2345V";
		pan4.name="Priya Desai";
		pan4.fatherName="Vijay Desai";
		pan4.dob="04-02-1992";
		pan4.PanCardDetails();

		PanCard pan5= new PanCard();
		pan5.panNumber="UVWXY6789Z";
		pan5.name=" Anil Pate";
		pan5.fatherName=" Ramesh Patel";
		pan5.dob=" 09-07-1988";
		pan5.PanCardDetails();
